...
<div class="span3">
				...
				<div class="control-group"> 
					...
					<div class="controls">
					<input type="text"  method ="post" class="w8em format-d-m-y highlight-days-67 range-low-today" name="due_date" id="sd" maxlength="10" style="border: 3px double #CCCCCC;" required/>
					</div>
				</div>
