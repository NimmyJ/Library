                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
								...
								ORDER BY borrow.borrow_id DESC
								  ")or die(mysql_error());
									...
									$borrow_accept_id=$row['borrow_details_id'];
									?>
									...
									<td> <a rel="tooltip"  title="Accept" id="<?php echo $borrow_accept_id; ?>" href="#accept_book<?php echo $borrow_accept_id; ?>" data-toggle="modal"    class="btn btn-success"><i class="icon-check icon-large" style="color: red" ></i>Accept</a>
                                    <?php include('model_accept.php'); ?></td>
